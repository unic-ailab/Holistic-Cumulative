...
class calcMetric(object):
    ...
    def calcDropout(train_acc,test_acc,base_dropout,_count):
        ...
        if   overfit_factor > 0.15:
            _count+=3
            return 1-base_dropout * 0.6,_count
        if   overfit_factor > 0.100:
            _count+=2
            return 1-base_dropout * 0.7,_count
        elif overfit_factor > 0.075:
            _count+=1
            return 1-base_dropout * 0.8,_count
        elif overfit_factor > 0.050:
            _count=0
            return 1-base_dropout * 0.9,_count
        else :
            _count=0
